...
import com.example.demo.model.PredictRequest;
import com.example.demo.model.PredictResponse;
...
public class MLService {
    ...
    public Map<String, String> mlRequestEndpoint(TowerDefenseMessage dataModel) {
    ...
    public Map<String, String> mapActionToGameState(String agent, int actionType, Map<String, Map<String, String>> towerStatus) {
        Map<String, String> actionItem = new HashMap<>();
